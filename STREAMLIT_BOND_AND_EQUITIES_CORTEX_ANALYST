...
AVAILABLE_SEMANTIC_MODELS_PATHS = [
    "GEN_AI_FSI.EQUITY_AND_BOND_ANALYST.SEMANTIC_MODELS/bond_holdings_yamwich.yaml",
    "GEN_AI_FSI.EQUITY_AND_BOND_ANALYST.SEMANTIC_MODELS/equities_yamwich.yaml"
]
...
def show_header_and_sidebar():
    ...
    st.title("Cortex Analyst - Bond & Equities")
    st.markdown(
